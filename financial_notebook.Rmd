...
```{r}
vars_M<- c("ID","FIPS_Code_State","FIPS_County","FIPS_Place","FIPS_Combined", "Name","Year4","Total_Revenue", "Total_Expenditure", "Total_Taxes","Water_Utility_Revenue","Water_Util_Total_Exp", 
...
vars_T<- c("GOVSid","FIPS_Code_State","FIPS_County","FIPS_Place","FIPS_Combined", "Name","Year4","Total_Revenue", "Total_Expenditure", "Total_Taxes","Water_Utility_Revenue","Water_Util_Total_Exp", 
         "Water_Util_Inter_Exp", "Water_Util_Cap_Outlay", "Water_Util_Current_Exp",
         "Water_Util_Construct", "Transit_Sub_Total_Exp", "Health_Total_Expend", "Parks___Rec_Total_Exp",
         "Police_Prot_Total_Exp", "Total_Debt_Outstanding", "Total_IG_Revenue", "Total_Rev_Own_Sources")
```
...
masterFIPS <- read.csv("/Users/miritfriedman/Desktop/Squeeze Data/financial/Confirmed_v6.csv")
```
...
```{r}
write.csv(fin_tidy,"final_financial_tidy_v6.csv")
```
...
Run this code to export it as a csv file
```{r}
write.csv(fin_27, "financial_27_v6.csv")
```
